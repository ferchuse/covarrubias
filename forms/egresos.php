							...
							<div class="panel panel-default">
								<div class="panel-body">
									<div class="form-group">
										<label  for="fecha_egresos" class="text-center">Fecha:</label>
										<input required type="date" class="form-control" name="fecha_egresos" id="fecha_egresos" value="<?php echo date("Y-m-d");?>">
									</div>
									<div class="form-group">
										<input required type="text" class="form-control hidden" name="id_egresos" id="id_egresos">
									...
									<div class="form-group">
										...
										<input required  type="number" min="0" class="form-control" name="cantidad_egresos" id="cantidad_egresos">
									</div>
									<div class="form-group">
