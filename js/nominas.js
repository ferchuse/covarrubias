	...
	function cargarTabla(filtros) {
		...
		$.ajax({
			...
			$('.btn_cancelar').click(function confirmaCancelacion() {
				...
				var folio_nominas = boton.data('folio_facturas');
				var id_nominas = boton.data('id_facturas');
				var fila = boton.closest('tr');
				function cancelarFactura(evet,value) {
					$.ajax({
						url: 'facturacion/cancelar_nominas.php',
						method: 'POST',
						data:{
							
							motivo_cancelacion: value,
							folio_nominas: folio_nominas,
